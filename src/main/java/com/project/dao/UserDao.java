...
public class UserDao {
    ...
    public User getUserByLogin(String login){
        ...
        try {
            ...
            result = new User(resultSet.getString("login"),resultSet.getString("password"),false, resultSet.getString("sex"), resultSet.getInt("age"), resultSet.getString("comment"),  resultSet.getString("email") );
        } catch (SQLException e) {
            e.printStackTrace();
        } finally {
            try {
