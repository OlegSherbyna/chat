 ...
 */
public class RegistretionFormProcessor {
    ...
    public boolean registerUser(HttpServletRequest request, ServletContext servletContext) throws ServletException, IOException {
        ...
        /*if( ((Set<User>) servletContext.getAttribute("registeredUserSet")).contains(user) ){
            wrongLoginOrPassword(request);
            return false;
        }*/
       ...
       //((Set<User>) servletContext.getAttribute("registeredUserSet")).add(user);
